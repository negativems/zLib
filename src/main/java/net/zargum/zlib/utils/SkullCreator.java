...
public class SkullCreator {
    ...
    /**
     * Applies the skin value to the ItemStack.
     * Method by negativems
     *
     * @param item The ItemStack to put the base64 onto
     * @param value The base64 string containing the texture
     * @return The head with a custom texture
     */
    public static ItemStack setValue(ItemStack item, String value) {
        notNull(item, "item");
        notNull(value, "value");
        if (!item.getType().equals(Material.SKULL_ITEM)) throw new IllegalStateException("Not skull");
