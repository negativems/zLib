 ...
 * <p>
 * You are welcome to use it, replace it and redistribute it under the following conditions:
 * <ul>
...
public enum ParticleEffect {
    ...
    public static final class ParticlePacket {
         ...
         *
         * @param center Center location of the effect
         * @param range  Range in which players will receive the packet (Maximum range for particles is usually 16, but it can differ for some
         *               types)
