...
import net.zargum.zlib.lunar.module.border.BorderManager;
import net.zargum.zlib.lunar.module.hologram.HologramManager;
import net.zargum.zlib.lunar.module.waypoint.WaypointManager;
import net.zargum.zlib.lunar.type.Notification;
import net.zargum.zlib.lunar.type.ServerRule;
import net.zargum.zlib.lunar.type.StaffModule;
import net.zargum.zlib.lunar.user.UserManager;
...
public abstract class LunarClientAPI {
    ...
    private static LunarClientAPI lunarApi;
    ...
    public static LunarClientAPI INSTANCE() {
        if (lunarApi == null) throw new LCAPIException();
        return lunarApi;
    }
